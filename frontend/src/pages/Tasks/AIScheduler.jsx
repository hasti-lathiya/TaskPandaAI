      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 pt-8 transition-all duration-300 animate-fade-in">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-slate-400 mt-1 max-w-xl text-sm font-semibold">
          ...
          <button
            ...
            disabled={loading}
            aria-busy={loading}
            className="w-full lg:w-auto bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold px-8 py-4 rounded-2xl shadow-lg hover:shadow-indigo-500/25 dark:hover:shadow-indigo-900/30 transition transform hover:-translate-y-0.5 disabled:opacity-50 disabled:pointer-events-none cursor-pointer flex items-center justify-center gap-2 text-sm"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="glass-premium rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full">
            <div className="w-12 h-12 rounded-2xl bg-amber-500/10 dark:bg-amber-950/40 text-amber-500 flex items-center justify-center text-2xl mb-4 border border-amber-500/10">
              ⚡
            </div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">High Priority First</h3>
          ...
          <div className="glass-premium rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full">
            <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 dark:bg-indigo-950/40 text-indigo-500 flex items-center justify-center text-2xl mb-4 border border-indigo-500/10">
              🧠
            </div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Smart Energy Pacing</h3>
            <p className="text-gray-500 dark:text-slate-400 mt-2 text-sm leading-relaxed font-medium">
          ...
          <div className="glass-premium rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full">
            <div className="w-12 h-12 rounded-2xl bg-pink-500/10 dark:bg-pink-950/40 text-pink-500 flex items-center justify-center text-2xl mb-4 border border-pink-500/10">
              🐼
            </div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Companion Growth Pacing</h3>
            <p className="text-gray-500 dark:text-slate-400 mt-2 text-sm leading-relaxed font-medium">
        ...
        {/* Loading state block */}
        {loading && (
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-[32px] p-8 shadow-md flex items-center gap-5 animate-pulse">
        ...
        {schedule && !loading && (
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-[32px] p-8 shadow-md animate-in fade-in slide-in-from-bottom-4 duration-300">
            
            <div className="flex items-center gap-4 mb-8 border-b border-gray-100 dark:border-slate-800 pb-5">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-indigo-500 to-purple-600 text-white flex items-center justify-center text-2xl shadow-md">
                📅
              </div>
              <div>
                ...
                .map((line, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="font-semibold text-slate-700 dark:text-slate-200 text-sm sm:text-base pr-4">
                        {task}
                      </div>
