  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className={`w-full bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 border border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 text-sm cursor-pointer flex items-center justify-between transition-all duration-200 hover:border-gray-300 dark:hover:border-slate-600 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed ${buttonClassName}`}
      >
