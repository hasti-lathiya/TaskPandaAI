  ...
  return (
    <div className="glass-premium rounded-2xl sm:rounded-[24px] p-4 sm:p-8 shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start gap-3 sm:gap-4 mb-6 sm:mb-8">
        ...
        <div className="bg-indigo-500/10 dark:bg-indigo-500/25 text-indigo-700 dark:text-indigo-400 px-3 sm:px-4.5 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl font-bold text-xs sm:text-sm border border-indigo-500/10 dark:border-indigo-500/30 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-6 sm:mt-8">
        ...
        <div className="bg-emerald-500/5 dark:bg-emerald-950/20 border border-emerald-500/10 dark:border-emerald-900/30 rounded-xl sm:rounded-[20px] p-3 sm:p-4 transition-all duration-300 hover:border-emerald-500/30">

          <p className="text-[10px] sm:text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
            🏆 Best Day
          </p>

          <h3 className="text-xl sm:text-2xl font-black text-emerald-600 dark:text-emerald-400 mt-1 sm:mt-2">
            {bestDay ? bestDay.day : "N/A"}
          </h3>

        </div>

        <div className="bg-amber-500/5 dark:bg-amber-950/20 border border-amber-500/10 dark:border-amber-900/30 rounded-xl sm:rounded-[20px] p-3 sm:p-4 transition-all duration-300 hover:border-amber-500/30">

          <p className="text-[10px] sm:text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
            ✅ Weekly Total
          </p>

          <h3 className="text-xl sm:text-2xl font-black text-amber-600 dark:text-amber-400 mt-1 sm:mt-2">
            {totalCompleted}
          </h3>
